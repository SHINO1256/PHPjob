...
if (isset($_POST["post"])) {
    ...
    if (!empty($_POST['title']) && !empty($_POST['date']) && !empty($_POST['stock'])) {
        ...
        try {
            ...
            $createError = '登録エラー :' . $e->getMessage();
            die();
        }
    } 
}
...
<body>
    ...
    <form action="" method="post">
        ...
        <h4 style="margin-bottom: 0;">在庫数</h4><br>
        ...
        <font color="red"><?php echo htmlspecialchars($titleError, ENT_QUOTES); ?></font><br>
        <font color="red"><?php echo htmlspecialchars($dateError, ENT_QUOTES); ?></font><br>
        <font color="red"><?php echo htmlspecialchars($stockError, ENT_QUOTES); ?></font><br>
        <font color="red"><?php echo htmlspecialchars($createError, ENT_QUOTES); ?></font><br>
    </form>
</body>
</html>